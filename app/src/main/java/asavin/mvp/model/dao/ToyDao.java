 ...
 * DAO for table "TOY".
*/
public class ToyDao extends AbstractDao<Toy, Long> {

    public static final String TABLENAME = "TOY";

    /**
     * Properties of entity Toy.<br/>
    ...
    public ToyDao(DaoConfig config) {
        super(config);
    }
    
    public ToyDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TOY\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TOY\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Toy entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Toy entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getPrice());
        stmt.bindLong(2, entity.getBrandId());
        stmt.bindString(3, entity.getImageResource());
    ...
    @Override
    public Toy readEntity(Cursor cursor, int offset) {
        Toy entity = new Toy( //
    ...
    @Override
    public void readEntity(Cursor cursor, Toy entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Toy entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Toy entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Toy entity) {
