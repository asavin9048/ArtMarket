 ...
 * DAO for table "BRUSH".
*/
public class BrushDao extends AbstractDao<Brush, Long> {

    public static final String TABLENAME = "BRUSH";

    /**
     * Properties of entity Brush.<br/>
    ...
    public BrushDao(DaoConfig config) {
        super(config);
    }
    
    public BrushDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BRUSH\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BRUSH\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Brush entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Brush entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getPrice());
        stmt.bindLong(2, entity.getBrandId());
        stmt.bindString(3, entity.getImageResource());
    ...
    @Override
    public Brush readEntity(Cursor cursor, int offset) {
        Brush entity = new Brush( //
    ...
    @Override
    public void readEntity(Cursor cursor, Brush entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Brush entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Brush entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Brush entity) {
