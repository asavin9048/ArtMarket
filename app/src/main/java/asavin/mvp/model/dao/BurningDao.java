...
/** 
 * DAO for table "BURNING".
*/
public class BurningDao extends AbstractDao<Burning, Long> {

    public static final String TABLENAME = "BURNING";

    /**
     * Properties of entity Burning.<br/>
    ...
    public BurningDao(DaoConfig config) {
        super(config);
    }
    
    public BurningDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BURNING\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BURNING\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Burning entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Burning entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getPrice());
        stmt.bindLong(2, entity.getBrandId());
        stmt.bindString(3, entity.getImageResource());
    ...
    @Override
    public Burning readEntity(Cursor cursor, int offset) {
        Burning entity = new Burning( //
    ...
    @Override
    public void readEntity(Cursor cursor, Burning entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Burning entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Burning entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Burning entity) {
