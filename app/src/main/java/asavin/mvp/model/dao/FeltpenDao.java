...
/** 
 * DAO for table "FELTPEN".
*/
public class FeltpenDao extends AbstractDao<Feltpen, Long> {

    public static final String TABLENAME = "FELTPEN";

    /**
     * Properties of entity Feltpen.<br/>
    ...
    public FeltpenDao(DaoConfig config) {
        super(config);
    }
    
    public FeltpenDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FELTPEN\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FELTPEN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Feltpen entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Feltpen entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getPrice());
        stmt.bindLong(2, entity.getBrandId());
        stmt.bindString(3, entity.getImageResource());
    ...
    @Override
    public Feltpen readEntity(Cursor cursor, int offset) {
        Feltpen entity = new Feltpen( //
    ...
    @Override
    public void readEntity(Cursor cursor, Feltpen entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Feltpen entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Feltpen entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Feltpen entity) {
