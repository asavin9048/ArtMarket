...
/** 
 * DAO for table "GILDING".
*/
public class GildingDao extends AbstractDao<Gilding, Long> {

    public static final String TABLENAME = "GILDING";

    /**
     * Properties of entity Gilding.<br/>
    ...
    public GildingDao(DaoConfig config) {
        super(config);
    }
    
    public GildingDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GILDING\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GILDING\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Gilding entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Gilding entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getPrice());
        stmt.bindLong(2, entity.getBrandId());
        stmt.bindString(3, entity.getImageResource());
    ...
    @Override
    public Gilding readEntity(Cursor cursor, int offset) {
        Gilding entity = new Gilding( //
    ...
    @Override
    public void readEntity(Cursor cursor, Gilding entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Gilding entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Gilding entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Gilding entity) {
