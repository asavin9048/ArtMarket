 ...
 * DAO for table "FRAME".
*/
public class FrameDao extends AbstractDao<Frame, Long> {

    public static final String TABLENAME = "FRAME";

    /**
     * Properties of entity Frame.<br/>
    ...
    public FrameDao(DaoConfig config) {
        super(config);
    }
    
    public FrameDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"FRAME\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"FRAME\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Frame entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Frame entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getPrice());
        stmt.bindLong(2, entity.getBrandId());
        stmt.bindString(3, entity.getImageResource());
    ...
    @Override
    public Frame readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, Frame entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Frame entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Frame entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Frame entity) {
