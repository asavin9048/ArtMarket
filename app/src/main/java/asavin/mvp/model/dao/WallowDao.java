...
/** 
 * DAO for table "WALLOW".
*/
public class WallowDao extends AbstractDao<Wallow, Long> {

    public static final String TABLENAME = "WALLOW";

    /**
     * Properties of entity Wallow.<br/>
    ...
    public WallowDao(DaoConfig config) {
        super(config);
    }
    
    public WallowDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WALLOW\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"WALLOW\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Wallow entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Wallow entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getPrice());
        stmt.bindLong(2, entity.getBrandId());
        stmt.bindString(3, entity.getImageResource());
    ...
    @Override
    public Wallow readEntity(Cursor cursor, int offset) {
        Wallow entity = new Wallow( //
    ...
    @Override
    public void readEntity(Cursor cursor, Wallow entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Wallow entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Wallow entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Wallow entity) {
