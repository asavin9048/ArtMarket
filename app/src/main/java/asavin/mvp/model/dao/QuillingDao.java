...
/** 
 * DAO for table "QUILLING".
*/
public class QuillingDao extends AbstractDao<Quilling, Long> {

    public static final String TABLENAME = "QUILLING";

    /**
     * Properties of entity Quilling.<br/>
    ...
    public QuillingDao(DaoConfig config) {
        super(config);
    }
    
    public QuillingDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"QUILLING\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"QUILLING\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Quilling entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Quilling entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getPrice());
        stmt.bindLong(2, entity.getBrandId());
        stmt.bindString(3, entity.getImageResource());
    ...
    @Override
    public Quilling readEntity(Cursor cursor, int offset) {
        Quilling entity = new Quilling( //
    ...
    @Override
    public void readEntity(Cursor cursor, Quilling entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Quilling entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Quilling entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Quilling entity) {
