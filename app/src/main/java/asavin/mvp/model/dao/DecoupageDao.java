...
/** 
 * DAO for table "DECOUPAGE".
*/
public class DecoupageDao extends AbstractDao<Decoupage, Long> {

    public static final String TABLENAME = "DECOUPAGE";

    /**
     * Properties of entity Decoupage.<br/>
    ...
    public DecoupageDao(DaoConfig config) {
        super(config);
    }
    
    public DecoupageDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DECOUPAGE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DECOUPAGE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Decoupage entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Decoupage entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getPrice());
        stmt.bindLong(2, entity.getBrandId());
        stmt.bindString(3, entity.getImageResource());
    ...
    @Override
    public Decoupage readEntity(Cursor cursor, int offset) {
        Decoupage entity = new Decoupage( //
    ...
    @Override
    public void readEntity(Cursor cursor, Decoupage entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Decoupage entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Decoupage entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Decoupage entity) {
