 ...
 * DAO for table "EASEL".
*/
public class EaselDao extends AbstractDao<Easel, Long> {

    public static final String TABLENAME = "EASEL";

    /**
     * Properties of entity Easel.<br/>
    ...
    public EaselDao(DaoConfig config) {
        super(config);
    }
    
    public EaselDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"EASEL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"EASEL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Easel entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Easel entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getPrice());
        stmt.bindLong(2, entity.getBrandId());
        stmt.bindString(3, entity.getImageResource());
    ...
    @Override
    public Easel readEntity(Cursor cursor, int offset) {
        Easel entity = new Easel( //
    ...
    @Override
    public void readEntity(Cursor cursor, Easel entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Easel entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Easel entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Easel entity) {
