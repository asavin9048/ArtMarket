...
/** 
 * DAO for table "PENCIL".
*/
public class PencilDao extends AbstractDao<Pencil, Long> {

    public static final String TABLENAME = "PENCIL";

    /**
     * Properties of entity Pencil.<br/>
    ...
    public PencilDao(DaoConfig config) {
        super(config);
    }
    
    public PencilDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PENCIL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PENCIL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, Pencil entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Pencil entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getPrice());
        stmt.bindLong(2, entity.getBrandId());
        stmt.bindString(3, entity.getImageResource());
    ...
    @Override
    public Pencil readEntity(Cursor cursor, int offset) {
        Pencil entity = new Pencil( //
    ...
    @Override
    public void readEntity(Cursor cursor, Pencil entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Pencil entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Pencil entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Pencil entity) {
